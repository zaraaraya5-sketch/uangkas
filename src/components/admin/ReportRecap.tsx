...
export const ReportRecap: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-3xl p-6 sm:p-7 border border-slate-200/80 shadow-soft flex flex-col sm:flex-row sm:items-center justify-between gap-5">
        <div>
      ...
      {/* Period Filter Tabs */}
      <div className="flex items-center gap-2 bg-white p-2 rounded-2xl border border-slate-200/80 shadow-soft w-fit">
      ...
      <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200/80 shadow-soft space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-xs">
          ...
          <div className="p-4 rounded-2xl bg-emerald-50/50 border border-emerald-100 space-y-2.5">
            <h4 className="font-bold text-emerald-800 uppercase tracking-wider flex items-center justify-between">
              <span>Pemasukan Iuran Kas Siswa</span>
              <span>{formatRupiah(overview.totalIncome)}</span>
            </h4>
          ...
          <div className="p-4 rounded-2xl bg-rose-50/50 border border-rose-100 space-y-2.5">
            <h4 className="font-bold text-rose-800 uppercase tracking-wider flex items-center justify-between">
              <span>Pengeluaran & Belanja Kas</span>
              <span>{formatRupiah(overview.totalExpense)}</span>
            </h4>
            <div className="space-y-1.5 text-slate-600 pt-1">
              <div className="flex justify-between">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-semibold text-slate-800">Peralatan & Keperluan Kelas</span>
              </div>
              <div className="flex justify-between">
        ...
        {/* Signatures preview */}
        <div className="pt-8 border-t border-slate-100 grid grid-cols-2 text-center text-xs text-slate-600">
          <div>
            <p>Mengetahui,</p>
            <p className="font-semibold text-slate-800 mt-1">Ketua Kelas</p>
            <div className="h-16"></div>
            <p className="font-bold text-slate-900 underline">{settings.classPresident}</p>
          ...
          <div>
            ...
            <div className="h-16"></div>
            <p className="font-bold text-slate-900 underline">{settings.treasurer1}</p>
